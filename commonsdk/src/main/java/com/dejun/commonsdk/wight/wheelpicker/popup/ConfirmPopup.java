package com.dejun.commonsdk.wight.wheelpicker.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = DensitySizeUtil.dp2px(activity, contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = DensitySizeUtil.dp2px(activity, contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = DensitySizeUtil.dp2px(activity, topHeight);
        ...
        int padding = DensitySizeUtil.dp2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(DensitySizeUtil.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = DensitySizeUtil.dp2px(activity, topPadding);
        ...
        submitButton.setTextColor(DensitySizeUtil.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
