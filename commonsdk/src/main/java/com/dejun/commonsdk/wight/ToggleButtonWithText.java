...
/**
 * Author:DoctorWei
 * Time:2018/11/13 9:19
 * Description:带文字的开关按钮
 * email:1348172474@qq.com
 */

public class ToggleButtonWithText extends View implements View.OnClickListener {
    /**
     * 最小高度    
     */
     ...
     *      * @param attrs   
     */
    public ToggleButtonWithText(Context context, AttributeSet attrs) {
        super(context, attrs);
