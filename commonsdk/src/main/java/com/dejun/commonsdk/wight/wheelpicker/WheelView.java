...
import com.dejun.commonsdk.wight.wheelpicker.entity.WheelItem;
...
public class WheelView extends View {
    ...
    private static final int ITEM_PADDING = 13;//单位为px,480X800的手机边距不能太大
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = DensitySizeUtil.dp2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = DensitySizeUtil.dp2px(getContext(), ITEM_PADDING);
            }
        ...
        Logger.d("measuredWidth=" + measuredWidth + ",measuredHeight=" + measuredHeight);
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = DensitySizeUtil.dp2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = DensitySizeUtil.dp2px(getContext(), 8);
                break;
            case Gravity.RIGHT:
